...
class SellingProgressTab extends StatelessWidget {
  const SellingProgressTab({super.key});
...
class SellingCompletedTab extends StatelessWidget {

  const SellingCompletedTab({super.key});
